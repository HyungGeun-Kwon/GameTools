...
namespace GameTools.Infrastructure.Migrations
{
    ...
    [Migration("20250816142952_AddItemAuditTrigger")]
    partial class AddItemAuditTrigger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameTools.Domain.Auditing.ItemAudit", b =>
                {
            ...
            modelBuilder.Entity("GameTools.Domain.Auditing.RarityAudit", b =>
                {
                    b.Property<long>("AuditId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GameTools.Domain.Entities.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameTools.Domain.Entities.Rarity", b =>
                {
                    b.Property<byte>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("GameTools.Domain.Entities.Item", b =>
                {
                    b.HasOne("GameTools.Domain.Entities.Rarity", "Rarity")
                        .WithMany("Items")
